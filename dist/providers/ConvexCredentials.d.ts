 ...
 * @module
 */
import { AuthProviderConfig, ConvexCredentialsConfig, GenericActionCtxWithAuthConfig } from "@convex-dev/auth/server";
 ...
 */
export declare function ConvexCredentials<DataModel extends GenericDataModel>(config: ConvexCredentialsUserConfig<DataModel>): ConvexCredentialsConfig;
